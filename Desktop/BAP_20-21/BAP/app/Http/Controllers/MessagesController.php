...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'contacts' => $users->count() > 0 ? $contacts : '<br><p class="message-hint"><span>Uw contacten lijst is leeg type de naam van een persoon in de zoekbalk en begin met chatten   </span></p>',
        ], 200);
    }
    ...
    public function getFavorites(Request $request)
    {
        ...
        return Response::json([
            'favorites' => $favorites->count() > 0
                ? $favoritesList
                : '<p class="message-hint"><span>Uw favoriete lijst is leeg</span></p>',
        ], 200);
    }
    ...
    public function search(Request $request)
    {
        ...
        return Response::json([
            'records' => $records->count() > 0
                ? $getRecords
                : '<p class="message-hint"><span>Niets om te tonen.</span></p>',
            'addData' => 'html'
        ], 200);
    }
